...
public class GoogleDriveServiceProvider {
	...
	private static String CLIENT_ID = "891643588974-p6dub3inep1ogujhr8i6tu1lqt0kkq11.apps.googleusercontent.com";
	private static String CLIENT_SECRET = "bjY5s-urMV1AaQ3YAguJIRlT";
